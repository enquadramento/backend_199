...
excel_path = os.path.join(base_dir, '..', 'data', 'tables', 'grafico_escolaridade_amost.xlsx')
...
fig = px.bar(
    ...
    color='Nível escolar', #separa a cor por microbacia
...
fig.update_layout(
    ...
    yaxis=dict(
        title='Escolaridade',                     # Título do eixo Y
...
saida_html = os.path.join(base_dir, '..', 'pg_panorama', 'grafico_escolaridade_amost.html')
